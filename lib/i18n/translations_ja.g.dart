...
class _TranslationsDrillsJa implements TranslationsDrillsEn {
	...
	@override String get exam_question_count => '出題数';
	@override String exam_question_count_details({required Object count, required Object total}) => '${count}問（全${total}問中）';
	@override String get access_status_label => '実施状態';
	@override String get access_period => '実施期間';
	@override String get access_starts_at => '開始日時';
	@override String get access_ends_at => '終了日時';
	@override String get not_started => '未開始';
	@override late final _TranslationsDrillsAccessStatusJa access_status = _TranslationsDrillsAccessStatusJa._(_root);
}
...
class _TranslationsHomeJa implements TranslationsHomeEn {
	...
	@override String get welcome_description_1 => 'DiQt（ディクト）は、絶対に忘れないAI辞書&単語帳アプリです。\n辞書で調べた単語に復習を設定することで、必ずその単語を覚えられます。';
...
class _TranslationsWordsJa implements TranslationsWordsEn {
	...
	@override String get bopomofo => '注音符号';
...
class _TranslationsDrillsAccessStatusJa implements TranslationsDrillsAccessStatusEn {
	_TranslationsDrillsAccessStatusJa._(this._root);

	final TranslationsJa _root; // ignore: unused_field

	// Translations
	@override String get ongoing => '実施中';
	@override String get unavailable => 'アクセス不可';
}
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'drills.exam_question_count': return '出題数';
			case 'drills.exam_question_count_details': return ({required Object count, required Object total}) => '${count}問（全${total}問中）';
			case 'drills.access_status_label': return '実施状態';
			case 'drills.access_period': return '実施期間';
			case 'drills.access_starts_at': return '開始日時';
			case 'drills.access_ends_at': return '終了日時';
			case 'drills.not_started': return '未開始';
			case 'drills.access_status.ongoing': return '実施中';
			case 'drills.access_status.unavailable': return 'アクセス不可';
			...
			case 'home.welcome_description_1': return 'DiQt（ディクト）は、絶対に忘れないAI辞書&単語帳アプリです。\n辞書で調べた単語に復習を設定することで、必ずその単語を覚えられます。';
			...
			case 'words.bopomofo': return '注音符号';
