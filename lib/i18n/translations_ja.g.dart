...
class _TranslationsHomeJa implements TranslationsHomeEn {
	...
	@override String get welcome_description_6 => 'ブラウザ拡張を使えば、パソコンで調べた単語もアプリから復習できます。パソコンで「ディクト　ブラウザ拡張」で検索してイントールしましょう！';
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'home.welcome_description_6': return 'ブラウザ拡張を使えば、パソコンで調べた単語もアプリから復習できます。パソコンで「ディクト　ブラウザ拡張」で検索してイントールしましょう！';
