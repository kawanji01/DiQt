...
class TranslationsDrillsEn {
	...
	String exam_question_count_details({required Object count, required Object total}) => '${count} questions (${total} total)';
	...
	late final TranslationsDrillsAccessStatusEn access_status = TranslationsDrillsAccessStatusEn._(_root);
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'drills.exam_question_count': return 'Questions';
			case 'drills.exam_question_count_details': return ({required Object count, required Object total}) => '${count} questions (${total} total)';
			case 'drills.access_status_label': return 'Status';
			case 'drills.access_period': return 'Period';
			case 'drills.access_starts_at': return 'Starts at';
			case 'drills.access_ends_at': return 'Ends at';
			case 'drills.not_started': return 'Not started';
			case 'drills.access_status.ongoing': return 'Ongoing';
			case 'drills.access_status.unavailable': return 'Unavailable';
			...
			case 'words.bopomofo': return 'Bopomofo';
