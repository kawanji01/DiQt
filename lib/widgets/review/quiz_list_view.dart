...
import 'package:booqs_mobile/widgets/review/list_quiz.dart';
...
class ReviewQuizListView extends ConsumerStatefulWidget {
  ...
  @override
  _ReviewQuizListViewState createState() => _ReviewQuizListViewState();
}

class _ReviewQuizListViewState extends ConsumerState<ReviewQuizListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return PagedListView<int, Review>(
      ...
      builderDelegate: PagedChildBuilderDelegate<Review>(
        itemBuilder: (context, item, index) => ReviewListQuiz(
          review: item,
        ),
