...
class SentenceRequestPendingWrapper extends StatefulWidget {
  const SentenceRequestPendingWrapper({super.key, required this.item});
  final Widget item;

  @override
  State<SentenceRequestPendingWrapper> createState() =>
      SentenceRequestPendingWrapperState();
}

class SentenceRequestPendingWrapperState
    extends State<SentenceRequestPendingWrapper> {
