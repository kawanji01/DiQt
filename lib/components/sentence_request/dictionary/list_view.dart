...
class SentenceRequestDictionaryListView extends StatefulWidget {
  const SentenceRequestDictionaryListView(
      {super.key, required this.dictionaryId, required this.selected});
  final int dictionaryId;
  final String selected;

  @override
  State<SentenceRequestDictionaryListView> createState() =>
      SentenceRequestDictionaryListViewState();
}

class SentenceRequestDictionaryListViewState
    extends State<SentenceRequestDictionaryListView> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    final Map resMap = await RemoteSentenceRequests.listForDictionary(
