...
class DictionaryMapSpeechTest extends StatefulWidget {
  const DictionaryMapSpeechTest(
      {super.key, required this.keywordController, required this.dictionary});
  final TextEditingController keywordController;
  final Dictionary dictionary;

  @override
  State<DictionaryMapSpeechTest> createState() =>
      _DictionaryMapSpeechTestState();
}

class _DictionaryMapSpeechTestState extends State<DictionaryMapSpeechTest> {
