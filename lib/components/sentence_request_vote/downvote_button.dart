...
class SentenceRequestVoteDownvoteButton extends StatelessWidget {
  const SentenceRequestVoteDownvoteButton(
      {super.key, required this.sentenceRequest, required this.upvoted});
    ...
    return Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 4),
            Text(sentenceRequest.downvotesCount.toString(),
                style: TextStyle(
                    fontSize: 14,
                    color: textColor,
