...
class NoticeSentenceRequestUpvoted extends StatelessWidget {
  const NoticeSentenceRequestUpvoted({super.key, required this.notice});
  final Notice notice;
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  t.notices
                      .sentence_request_upvoted_message(name: notifying.name),
