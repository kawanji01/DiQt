...
class QuizRequestDictionaryListView extends StatefulWidget {
  const QuizRequestDictionaryListView(
      {super.key, required this.dictionaryId, required this.selected});
  final int dictionaryId;
  final String selected;

  @override
  State<QuizRequestDictionaryListView> createState() =>
      QuizRequestDictionaryListViewState();
}

class QuizRequestDictionaryListViewState
    extends State<QuizRequestDictionaryListView> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    ...
    final Map resMap = await RemoteQuizRequests.listForDictionary(
