...
class QuizRequestDictionaryTabs extends StatelessWidget {
  const QuizRequestDictionaryTabs(
  ...
  Widget build(BuildContext context) {
    ...
    Widget accepted() {
      ...
      final text = RichText(
        ...
        text: TextSpan(
            text:
                '${t.wordRequests.acceptance}\n(${dictionary.acceptedQuizRequestsCount})',
            style: style),
      );
      return InkWell(
        onTap: () {
          QuizRequestDictionaryPage.pushReplacement(
    ...
    Widget pending() {
      ...
      final text = RichText(
        ...
        text: TextSpan(
            text:
                '${t.wordRequests.pending}\n(${dictionary.pendingQuizRequestsCount})',
            style: style),
      );
      return InkWell(
        onTap: () {
    ...
    Widget rejected() {
      ...
      final text = RichText(
        ...
        text: TextSpan(
            text:
                '${t.wordRequests.rejection}\n(${dictionary.rejectedQuizRequestsCount()})',
            style: style),
      );
      return InkWell(
        onTap: () {
