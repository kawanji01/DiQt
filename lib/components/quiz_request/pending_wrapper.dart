...
class QuizRequestPendingWrapper extends StatefulWidget {
  const QuizRequestPendingWrapper({super.key, required this.item});
  final Widget item;

  @override
  State<QuizRequestPendingWrapper> createState() =>
      QuizRequestPendingWrapperState();
}

class QuizRequestPendingWrapperState extends State<QuizRequestPendingWrapper> {
