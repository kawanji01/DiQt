...
struct LockScreenWidgetsLiveActivity_Previews: PreviewProvider {
    static let attributes = LockScreenWidgetsAttributes(name: "Me")
    static let contentState = LockScreenWidgetsAttributes.ContentState(value: 3)
