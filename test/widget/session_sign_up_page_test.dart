...
void main() {
  group('SessionSignUpPage Widget Tests', () {
    Widget createWidget() {
      return ProviderScope(
        child: MaterialApp(
          home: const SessionSignUpPage(),
    ...
    testWidgets('should display sign up form', (WidgetTester tester) async {
      ...
      // SessionSignUpFormコンポーネントが表示されることを確認
    ...
    testWidgets('should display login recommendation section', (WidgetTester tester) async {
      await tester.pumpWidget(createWidget());
      await tester.pump();
